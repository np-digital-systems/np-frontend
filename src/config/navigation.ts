...

  {
    ...
    items: [
      ...
      },
      {
        id: 'sponsors',
        label: 'Sponsors',
        href: CONTRIBUTION_ROUTES.sponsors,
        icon: 'user',
        description: 'The sponsor register — who sponsors what, and their details',
        requiredPermission: 'sponsor:view',
      },
      {
        id: 'sanththa',
        label: 'Sanththa',
        ...
        icon: 'users',
        description: 'The yearly subscription every sponsor owes',
